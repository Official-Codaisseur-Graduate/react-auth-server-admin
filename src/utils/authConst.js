...
const authConfig = {
    ...
    redirectUri: process.env.REACT_APP_REDIRECT_URL || "https://172.16.29.134:3000",
    login: authority + "/auth",
    silentRedirectUri: process.env.REACT_APP_SILENT_REDIRECT_URL || "https://172.16.29.134:3000/silentrenew",
    postLogoutRedirectUri: process.env.REACT_APP_LOGOFF_REDIRECT_URL || "https://172.16.29.134:3000/logout/callback",
