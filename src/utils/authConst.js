...
const authConfig = {
    ...
    silentRedirectUri: process.env.REACT_APP_SILENT_REDIRECT_URL || "http://172.16.29.134:3000/silentrenew",
    postLogoutRedirectUri: process.env.REACT_APP_LOGOFF_REDIRECT_URL || "http://172.16.29.134:3000/logout/callback",
